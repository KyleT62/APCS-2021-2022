package com.company.TwoDimensionalArrays.NitalSquare;
...
public class NitalTester {
     ...
     */
    public static boolean isNital(int[][] square){ //fix (case checking?)
        for(int i = 0; i < square.length; i++){
            if(containsRepeats(getColumn(square, i)) == true){
                return false;
            }
            if(hasAllValues(getColumn(square,i),square[0])== true){
                return true;
            }
        }
